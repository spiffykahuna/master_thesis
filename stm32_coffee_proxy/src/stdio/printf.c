...
int dbl2stri(char *outbfr, double dbl, int dec_digits)
{
...
*/
signed int fputc(signed int ch, FILE *pStream)
{
	if(pStream == stdout) {

		USART_SendData(STDOUT_USART, ch);
	...
	{
		USART_SendData(STDERR_USART, ch);
