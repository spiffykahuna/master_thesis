...
Regular \gls{WSDL} document contains some necessary elements ~\cite{wsdl_language_spec, wikipedia:WSDL}:
...
\autoref{sec:appendix_service_contracts}. This is example from the \gls{WSDL}
standart. It 
