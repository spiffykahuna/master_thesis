...
The  Service  Oriented  Architecture  (SOA)  may  be  defined  as  a 
paradigm that allows the construction of loosely-coupled software components,  which  provide  services  to  clients  and  may  be 
dynamically  located  and  invoked  using  a  well-known communication protocol. 
